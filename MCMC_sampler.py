...
class Sampler:
    ...
    def make_random_assignment_integer(self):
        ...
        for i in range(0,n):
            self.current_values_integer.append(random.randint(0,1000)) # assume 1000 is the maximum number 'make an enhancement' !
    ...
    def metropolis_move(self):
        ...
        if random_variable_is_int_or_bool == 0:
            ...
            self.current_values_boolean[boolean_variable_names.index(selected_boolean_variable)]=(self.current_values_boolean[boolean_variable_names.index(selected_boolean_variable)]-1)%2
        else:
